...
const Lead = ({ children, light = false, className = "" }) => (
  <p
    className={`text-[15px] sm:text-base leading-[1.75] font-light max-w-[520px] ${className}`}
...
const AnnounceBanner = () => (
  ...
  >
    Next intake opens <strong style={{ color: C.gold }}>October 2025</strong> —
    ...
    >
      ...
      >
        ...
        <div className="py-12 sm:py-16 lg:py-20">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 mb-5">
            {["Delivery-Focused", "Leadership-Ready", "Agile & Waterfall"].map(
              (t) => (
                <span
                  key={t}
          ...
          <p
            className="text-[14px] sm:text-[15px] sm:text-base leading-[1.75] font-light mb-8 max-w-[500px]"
            style={{ color: "rgba(255,255,255,0.6)" }}
          >
            Step into the role that sits at the centre of every successful
            software project — bridging business expectations, development
            teams, and stakeholder confidence, from kickoff to go-live.
          </p>
      ...
      <div className="lg:hidden px-5 sm:px-8 pb-10 relative z-10">
        <div className="rounded p-5 sm:p-6" style={{ background: C.gold }}>
          ...
          <div
            className="font-bold tracking-[-1px] leading-none mb-1"
            style={{
              fontFamily: "'Playfair Display',Georgia,serif",
          ...
          <div
            ...
            style={{ color: "rgba(0,0,0,0.6)" }}
          >
            Zero-cost EMI from <strong>₹5,833/month</strong>
          </div>
          <a
            href="#enrol"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-stretch" style={{ height: 52 }}>
        ...
        <div
          className="pm-wrap flex-1 overflow-hidden relative"
          style={{
            maskImage:
        ...
        >
          <div
            className="pm-track flex items-center h-full"
            style={{
              width: "max-content",
              animation: "marquee-pm 26s linear infinite",
            }}
          >
            {items.map((c, i) => (
              <div
...
const About = () => {
  const stats = [
    {
      num: "32L+",
      lbl: "Highest package offered to a programme graduate",
      dark: false,
    },
    {
      num: "2,100+",
      lbl: "Project managers trained and placed since inception",
      dark: true,
    },
    {
      num: "60%",
      lbl: "Average salary hike for working professionals",
      dark: false,
    },
    {
      num: "150+",
      lbl: "Companies actively hiring from our PM network",
      dark: false,
    },
  ];
  return (
    <section
      id="about"
      className={`${sectionBase} border-b`}
      ...
      <Wrap>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[80px] items-center">
          <div>
            ...
            <Display>
              We Train You to Lead
              <br />
              <Em>Delivery. Not Just Manage It.</Em>
            </Display>
            <p
              className="text-[15px] leading-[1.8] font-light mt-5 mb-5"
              style={{ color: C.stone }}
            >
              Project Management is the most misunderstood role in software
              delivery. Most organisations confuse it with coordination —
              scheduling meetings, updating Jira boards, and chasing status
              updates. Real project management is something altogether
              different.
            </p>
            <blockquote
            ...
            >
              A project manager who cannot lead the room cannot lead the
              project. This programme changes that.
            </blockquote>
            <p
              className="text-[15px] leading-[1.8] font-light mb-4"
              style={{ color: C.stone }}
            >
              From inception and planning through delivery, stakeholder
              management, risk governance, and change control — every module is
              designed around{" "}
              <strong style={{ color: C.navy, fontWeight: 600 }}>
                what actually happens on active software delivery projects
              </strong>
              .
            </p>
            <p
            ...
            >
              ...
              running live delivery programmes across banking, insurance,
  ...
  const cards = [
    {
      label: "Duration",
      value: "4 Weeks",
      sub: "Intensive but manageable — designed around the pace of real project delivery cycles.",
      dark: false,
    },
    {
      label: "Timings",
      value: "Evenings & Weekends",
      sub: "Scheduled so working professionals can upskill without stepping away from their current role.",
      dark: false,
    },
    {
      label: "Mode",
      value: "Live Online + LMS",
      sub: "Real-time instructor-led sessions with full recording access and downloadable resources.",
      dark: false,
    },
    {
      label: "Batch Size",
      value: "5 Students Per Batch",
      sub: "Intentionally small. Every participant receives direct mentorship and individual feedback.",
      dark: false,
    },
    {
      label: "Who Can Join?",
      value: "IT Professionals & Leads",
      sub: "Developers, testers, BAs, and team leads moving into delivery leadership.",
      dark: false,
    },
    {
      label: "Programme Fee",
      value: "₹32,000",
      sub: "Zero-cost EMI from ₹5,833/month. No hidden fees. Merit-based scholarships available.",
      dark: true,
    },
  ];
  return (
    ...
    >
      <Wrap>
        ...
        <Display>
          Structured for the <Em>Serious Professional.</Em>
        </Display>
        <div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px mt-10 sm:mt-12"
          style={{ background: C.border, border: `1px solid ${C.border}` }}
        >
          {cards.map((c, i) => (
            <div
...
const Prerequisites = () => {
  const items = [
    {
      ...
      desc: "A project manager lives and dies by how clearly they communicate — with stakeholders, development teams, senior leadership, and clients. You do not need to be a natural speaker; you need to be a committed one. We build on what you have.",
    },
    {
      num: "02",
      title: "Team Management Experience",
      desc: "You should have worked alongside developers, testers, or business analysts. Direct people management experience is not mandatory, but an understanding of how cross-functional teams operate is essential.",
    },
    {
      num: "03",
      title: "Business Process Understanding",
      desc: "A project manager who cannot grasp the business problem cannot manage the solution. You should be comfortable engaging with business stakeholders and translating client expectations into delivery direction.",
    },
  ];
  const tags = [
    "Senior Developer",
  ...
  return (
    <section
      id="prerequisites"
      className={`relative overflow-hidden ${sectionBase}`}
      style={{
        background: C.navy,
        backgroundImage: `
      linear-gradient(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[80px] mt-10 sm:mt-14 items-start">
          ...
          >
            {items.map((it, i) => (
              <div
                key={i}
                className="grid gap-4 sm:gap-5 py-6 sm:py-7 items-start"
                style={{
              ...
              >
                <div
                  className="font-bold text-[13px] mt-0.5"
                  style={{
                    fontFamily: "'Playfair Display',Georgia,serif",
                    color: C.gold,
                  }}
                ...
                <div>
                  ...
                  <p
                    className="text-[14px] leading-[1.65] font-light"
                    style={{ color: "rgba(255,255,255,0.5)" }}
                  >
                    {it.desc}
                  </p>
          ...
          {/* Panel */}
          <div
            className="rounded-lg p-7 sm:p-9 border"
            style={{
          ...
          >
            <div
              className="font-bold text-[18px] sm:text-[20px] text-white tracking-[-0.4px] mb-2"
            ...
            <div className="flex flex-wrap gap-2.5">
              {tags.map((t) => (
                <span
                  key={t}
                  className="text-[12px] font-semibold px-3.5 py-1.5 rounded-sm border"
                  style={{
                    color: C.gold,
            ...
            >
              <p
                className="text-[13px] leading-[1.65] font-light mb-4"
                style={{ color: "rgba(255,255,255,0.45)" }}
              >
...
const Objectives = () => {
  ...
  const objs = [
    {
      num: "01",
      title: "Own End-to-End Software Delivery",
      desc: "Lead a project from the first stakeholder conversation through to post-implementation review — with full accountability for scope, timeline, budget, and quality.",
    },
    {
      num: "02",
      title: "Direct a Development Team",
      desc: "Provide clear direction to developers, testers, and BAs — resolving blockers, managing dependencies, and keeping delivery momentum without becoming a bottleneck.",
    },
    {
      num: "03",
      title: "Manage Business Relationships",
      desc: "Build and sustain productive working relationships with the business side — translating ambiguity into clarity, managing expectations, and communicating project status with confidence.",
    },
    {
      num: "04",
      title: "Navigate Conflict & Stay on Track",
      desc: "Handle conflict between stakeholders, within teams, and across delivery boundaries — while maintaining focus on outcomes and keeping every party aligned to the shared goal.",
    },
    {
      num: "05",
      title: "Lead with Credibility",
      desc: "Demonstrate the leadership qualities that earn a team's trust — decisiveness, presence, clear communication, and the ability to make difficult calls under pressure.",
    },
    {
      num: "06",
      title: "Govern Scope, Risk & Budget",
      desc: "Apply structured governance frameworks to manage the three constraints that determine whether projects succeed or fail — preventing scope creep, identifying risk early, and controlling cost.",
    },
  ];
  return (
    <section
      ...
      <Wrap>
        ...
        >
          ...
          >
            ...
            >
              Manage scope changes, shifting priorities, and evolving
              stakeholder requirements without derailing delivery — using
              structured change control processes and agile principles in equal
              measure.
            </p>
          </div>
        </div>
...
const Curriculum = () => {
  ...
  const modules = [
    {
      title: "Introduction to Project Management in Software Delivery",
      body: "What project management actually means inside a technology organisation — how it differs from general management, where the PM sits within the project structure, and what the role demands day to day. We challenge misconceptions early and establish a clear picture of the function participants are preparing for.",
      tags: ["Foundation", "Role Clarity", "SDLC Context"],
    },
    {
      title: "Project — Definition, Inception & Evolution",
      body: "How projects begin — the business case, feasibility assessment, project charter, and initial stakeholder identification. Understanding what transforms a business problem into a funded project with defined scope and measurable outcomes.",
      tags: ["Project Charter", "Feasibility", "Stakeholder ID"],
    },
    {
      title: "Project Life Cycle — End-to-End Delivery",
      body: "The full project lifecycle from initiation through planning, execution, monitoring, and closure. Each phase examined in depth — what decisions are made, what documents are produced, who is involved, and what causes projects to fail at each stage.",
      tags: ["Initiation", "Execution", "Closure", "PMI Aligned"],
    },
    {
      title: "Agile Project Management — Scrum & Kanban",
      body: "A practical, non-theoretical guide to Agile in enterprise environments. Scrum roles, ceremonies, and artefacts — sprint planning, daily standups, retrospectives, backlog refinement — and how a PM leads within and around the Scrum framework. Kanban flow management, WIP limits, and board design.",
      tags: ["Scrum", "Kanban", "Sprint Planning", "Backlog"],
    },
    {
      title: "Project Planning & Stakeholder Management",
      body: "Building a project plan that reflects reality — WBS, dependency mapping, effort estimation, resource planning, and critical path analysis. Stakeholder identification, power-interest mapping, communication planning, and the practical skills required to manage competing interests.",
      tags: ["WBS", "Critical Path", "Stakeholder Matrix"],
    },
    {
      title: "Primary Constraints — Scope, Time, Budget & Quality",
      body: "The iron triangle — and the fourth dimension of quality that PM textbooks often underweight. Scope definition and change control, schedule management and earned value, budget tracking and variance analysis, and quality assurance processes.",
      tags: ["Scope Control", "Earned Value", "Budget Variance", "QA"],
    },
    {
      title: "Project Manager Roles & Responsibilities",
      body: "A granular examination of what a PM actually does at each project stage — across planning, execution, escalation, reporting, vendor coordination, and team leadership. Conflict resolution frameworks, escalation protocols, and the interpersonal dynamics of leading teams.",
      tags: ["Leadership", "Conflict Resolution", "Escalation", "Reporting"],
    },
    {
      title: "Project Management Tools & Software",
      body: "Hands-on practice with the tools real delivery teams use — MS Project for traditional planning, Jira for agile delivery management, Confluence for documentation, and communication tools including Slack and Teams.",
      tags: ["MS Project", "Jira", "Confluence", "Gantt Charts"],
    },
    {
      title: "Change Management",
      body: "The science and practice of managing change — both at the project level (scope, requirements, and technical change requests) and at the organisational level (navigating change resistance, communication strategy, and adoption). Structured change control processes and impact assessment frameworks.",
      tags: ["Change Control", "Impact Assessment", "Organisational Change"],
    },
  ];
  return (
    <section
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8 lg:gap-[80px] items-start">
          <div className="lg:sticky lg:top-[80px]">
            ...
            <Display>
              Everything the Job
              <br />
              Demands. <Em>Covered.</Em>
            </Display>
            <Lead className="mt-4">
              Nine modules that build from first principles through to advanced
              delivery leadership — covering both the rigour of structured PM
              and the agility modern teams require.
            </Lead>
            <div
            ...
            >
              ...
              <div>
                ...
                <span className="text-[12px]" style={{ color: C.stone }}>
                  Programme Lead — 14 yrs in Software Delivery
                </span>
              </div>
            </div>
          </div>
  ...
  const tools = [
    {
      icon: (
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7QdGY_vcel5ypke_gomPKecM-ibedY9lU7A&s"
          alt=""
          srcset=""
        />
      ),
      name: "MS Project",
      desc: "Gantt charts, resource allocation, baseline management, and critical path tracking",
    },
    {
      icon: (
        <img
      ...
      name: "Jira",
      desc: "Agile backlog management, sprint boards, epics, velocity tracking, and workflow configuration",
    },
    {
      icon: (
        <img
      ...
      name: "Confluence",
      desc: "Project documentation, knowledge management, requirements pages, and meeting minute templates",
    },
    {
      icon: (
        <img
      ...
      name: "MS Excel / Sheets",
      desc: "RAID logs, budget tracking, stakeholder registers, and project reporting dashboards",
    },
    {
      icon: (
        <img
          src="https://www.uctoday.com/wp-content/uploads/2019/10/MicrosoftTeamsKillingSlack.jpg"
          alt=""
          srcset=""
        />
      ),
      name: "Slack & Teams",
      desc: "Communication protocols, channel structuring, status update cadence, and escalation pathways",
    },
    {
      icon: (
        <img
          src="https://e7.pngegg.com/pngimages/26/74/png-clipart-trello-logo-slack-atlassian-trello-blue-text-thumbnail.png"
          alt=""
          srcset=""
        />
      ),
      name: "Trello / Asana",
      desc: "Lightweight project tracking — task management, deadlines, board views, and cross-team visibility",
    },
    {
      icon: (
        <img
      ...
      desc: "Project reporting and KPI visualisation — status dashboards that stakeholders can read and action",
    },
    {
      icon: (
        <img
          src="https://cdn.iconscout.com/icon/free/png-256/free-azure-devops-icon-svg-download-png-3029870.png"
          alt=""
          srcset=""
        />
      ),
      name: "Azure DevOps",
      desc: "Work item tracking, pipeline visibility, and sprint management in Microsoft-stack environments",
    },
  ];
  return (
    <section
      id="tools"
      className={`relative overflow-hidden ${sectionBase} border-b`}
      style={{
        background: C.navy,
        borderColor: "rgba(255,255,255,0.08)",
        backgroundImage: `
    ...
    >
      ...
      <Wrap className="relative z-10">
        ...
        <Display light className="mt-1">
          The <Em>Exact Toolkit</Em>
          <br />
          Every PM Needs.
        </Display>
        <Lead light className="mt-4">
          Hiring managers do not just look for methodology knowledge. They look
          for candidates who can open the tools and get to work. We ensure you
          can.
        </Lead>
          ...
          {tools.map((t, i) => (
            ...
            >
              <div className="w-10 h-10 sm:w-[52px] sm:h-[52px] rounded-xl bg-white flex items-center justify-center flex-shrink-0">
                <span className="text-[18px] sm:text-[24px] leading-none">
                  {t.icon}
                </span>
              </div>
...
const WhyUs = () => {
  const cards = [
    {
      icon: "🏗",
      title: "Trainers Running Live Projects",
      desc: "Every trainer is a working project manager with active delivery responsibilities. The scenarios they teach from are ones they navigated this quarter — not archived case studies.",
    },
    {
      icon: "⚡",
      title: "Both Agile and Waterfall — Without Compromise",
      desc: "Most programmes pick a side. Real delivery environments do not. We train participants to operate confidently across Agile, hybrid, and structured waterfall environments.",
    },
    {
      icon: "👥",
    ...
    {
      icon: "🎭",
      title: "Leadership Is Trained, Not Mentioned",
      desc: "We simulate it — conflict resolution role-plays, escalation exercises, and stakeholder management scenarios that build genuine capability, not confidence without substance.",
    },
    {
      icon: "📁",
      title: "Deliverables That Prove the Work",
      desc: "Graduates leave with two completed project artefact sets — a full project plan for a waterfall engagement and a sprint-complete Agile delivery.",
    },
    {
      icon: "🤝",
      title: "Placement Until You Are Placed",
      desc: "A dedicated placement manager, active recruiter network of 150+ companies, mock interview coaching, and post-offer support — sustained until you have an offer you are ready to accept.",
    },
  ];
  return (
    <section
    ...
    >
      ...
      <Wrap className="relative z-10">
        ...
        <Display light className="mt-1">
          What Separates This
          <br />
          <Em>From Everything Else.</Em>
        </Display>
        <Lead light className="mt-4">
          There is no shortage of project management courses. There is a real
          shortage of programmes that produce graduates who can actually walk
          into a delivery leadership role.
        </Lead>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 mt-10 sm:mt-12">
          {cards.map((c, i) => (
            <div
              key={i}
              className="flex flex-col gap-3 p-5 sm:p-7 rounded-lg border transition-all duration-200"
              style={{
                background: "rgba(255,255,255,0.04)",
                borderColor: "rgba(255,255,255,0.08)",
              }}
...
const Projects = () => {
  const steps = [
    {
      num: "01",
      title: "Full Waterfall Delivery — End-to-End Project Plan",
      body: "Take a defined business problem through the complete traditional project lifecycle — charter, WBS, detailed project plan with Gantt, RAID log, stakeholder communication plan, risk register, and a mock steering committee presentation.",
    },
    {
      num: "02",
      title: "Agile Sprint Delivery — Scrum Simulation",
      body: "Run three full Scrum sprints on a simulated software product — backlog creation and prioritisation, sprint planning, daily standups, sprint review, retrospective facilitation, and velocity tracking.",
    },
    {
      num: "03",
      title: "Panel Review & Professional Presentation",
      body: "Present both project artefacts to a panel of working project managers and receive structured professional feedback — on technical accuracy, decision quality, communication clarity, and stakeholder management.",
    },
  ];
  const outcomes = [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[80px] items-start">
          <div>
            ...
            <Display>
              Two Projects.
              <br />
              <Em>Real Artefacts.</Em>
            </Display>
            <Lead className="mt-4">
              Project management cannot be assessed through multiple-choice
              tests. It is demonstrated through the quality of the work you
              produce under realistic conditions.
            </Lead>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                A Profile That
                <br />
                <em style={{ color: C.gold }}>Earns the Interview.</em>
              </div>
...
const Career = () => {
  ...
  const cards = [
    {
      icon: "📄",
      title: "PM-Specific Resume Crafting",
      desc: "Your resume built by professionals who know what PM hiring managers look for — framing your prior experience in delivery terms, not generic job description language.",
    },
    {
      icon: "🎤",
      title: "Technical & Behavioural Interview Prep",
      desc: "Mock PM interviews covering both scenario-based questions and situational leadership — practised with working professionals who have sat on both sides of the hiring table.",
    },
    {
      icon: "🌐",
      title: "Recruiter Network — 150+ Companies",
      desc: "Active introductions to hiring partners across IT services, banking, fintech, consulting, and product companies. Not job board access — direct referrals from our placement team.",
    },
    {
      icon: "🔗",
      title: "LinkedIn & Profile Positioning",
      desc: "Complete LinkedIn optimisation for PM hiring — headline, summary, experience framing, and project portfolio section — so recruiters find you, not just the other way around.",
    },
  ];
  return (
    <section
...
const BottomCTA = () => {
  ...
  const fldStyle = (key) => ({
    background: C.cream,
    borderColor: errors[key] ? C.gold : C.border,
    color: C.ink,
        ...
        <div className="relative z-10 py-14 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[80px] items-center">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "rgba(255,255,255,0.5)" }}
            >
              Our advisors are working project managers who have navigated
              exactly the transition you are considering. No scripts, no
              pressure — just honest guidance about whether this programme is
              right for you.
            </p>
      ...
      <Wrap>
        ...
        >
          <div className="col-span-2 lg:col-span-1">
            ...
            <p
              className="text-[13px] leading-[1.7] font-light max-w-[280px]"
              style={{ color: "rgba(255,255,255,0.4)" }}
            >
              Practical, industry-aligned Project Management training — built
              for the delivery role, not the exam. Training is the beginning.
        ...
        >
          <p>
            © 2025 CodersBloom. All rights reserved. Training is the beginning.
            Placement is the promise.™
          </p>
