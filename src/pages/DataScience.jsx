      ...
      <div className="lg:hidden px-5 sm:px-8 pb-10 relative z-10">
        <div className="rounded p-5 sm:p-6" style={{ background: C.gold }}>
          ...
          <div className="font-bold tracking-[-1px] leading-none mb-1"
            style={{ fontFamily: "'Playfair Display',Georgia,serif", fontSize: "clamp(28px,8vw,36px)", color: C.navy }}>₹79,999</div>
...
const Methodology = () => {
  const bars = [
    { pct: "40%", title: "Case Studies & Discussion", desc: "Real business problems used to create meaningful analytical exercises. Every concept is introduced through a scenario that reflects how organisations actually use data to make decisions.", dark: false },
    { pct: "30%", title: "Simulation & Projects", desc: "People learn best when they build. Our simulations create genuine decision-making pressure under realistic business conditions — with data that misbehaves and problems that do not have clean answers.", dark: true },
    { pct: "30%", title: "Theory & Application", desc: "We use theory only where it adds value — and immediately connect it to practical execution. No concept is taught in isolation from the real problem it is designed to solve.", dark: false },
  ];
  return (
...
const Footer = () => {
  ...
  const cols = [
    { title: "Programme", links: [{ label: "Curriculum", id: "curriculum" }, { label: "Tools Covered", id: "tools" }, { label: "Industry Domains", id: "domains" }, { label: "Capstone Projects", id: "projects" }] },
